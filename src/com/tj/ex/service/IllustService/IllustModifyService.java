...
public class IllustModifyService implements Service {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			String dbFileName = mRequest.getParameter("iFilename");
			if (iFilename == null) {
				iFilename = dbFileName;
			}
			int iNum = Integer.parseInt(mRequest.getParameter("iNum"));
			...
			int result = Dao.modify(iNum, iTitle, iContent, iFilename, iPw);
